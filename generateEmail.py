...
<body>
  <div style="">
          ...
          <![endif]-->
                <div class="mj-column-px-600 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                          <tbody>
                            <tr>
                              <td style="width:162px;"><a href="praxtrain.com"><img height="auto" src="https://image.ibb.co/eBt9EK/praxlogo.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="162" /></a> </td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:sans-serif Neue;font-size:40px;line-height:1;text-align:center;color:#fff;"> '''
    ...
    <div style="background:#f0f0f0;background-color:#f0f0f0;Margin:0px auto;max-width:600px;">
      ...
      <![endif]-->
        ...
        <tr>
            ...
            >
          <![endif]-->
                        <div style="font-family:helvetica;font-size:20px;font-weight:bold;line-height:1;text-align:center;color:#AD343E;"> ADS </div>
                        <!--[if mso | IE]>
            </td>
    ...
    for k,v in adsPraxis.items():
        html += '''<div style="Margin:0px auto;max-width:500px;">
                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                  <tbody>
                    <tr>
...
<div style="Margin:0px auto;max-width:500px;">
        ...
        <tr>
            ...
            >
          <![endif]-->
                        <div style="font-family:helvetica;font-size:20px;font-weight:bold;line-height:1;text-align:center;color:#AD343E;"> PRAXIS </div>
                        <!--[if mso | IE]>
            </td>
    ...
    <div style="Margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
        ...
        <tr>
            ...
            >
          <![endif]-->
              <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:12px;line-height:1;text-align:left;color:#a0a0a0;"> You have been sent this email because you are subscribed PraxTrain. If you no longer wish to receive emails from PraxTrain, you can <a style="color:#a0a0a0;" href="'''
    html+= unsubURL
    html+= '''"> Unsubscribe</a>. </div>
              <!--[if mso | IE]>
            </td>
